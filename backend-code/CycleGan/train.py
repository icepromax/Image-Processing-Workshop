...
from models import *
from models.CycleGan.model import *
from models.CycleGan.datasets import *
from utils import *
...
dataloader = DataLoader(  ## 改成自己存放文件的目录
    ImageDataset("data", transforms_=transforms_, unaligned=True),
...
val_dataloader = DataLoader(
    ImageDataset("data", transforms_=transforms_, unaligned=True, mode="test"),  ## "./datasets/facades"
    batch_size=5,
    shuffle=True,
    num_workers=1,
)
